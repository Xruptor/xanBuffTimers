...
L.RetailWarningBody = "xanBuffTimers now has improved Retail support, but behaviour depends on where you are:\n\n|cFF00FF00OPEN WORLD / BATTLEGROUNDS:|r\nFully functional. Buff icons, timers, and bars all display normally.\n\n|cFFFFFF00INSTANCES / RAIDS / ARENAS:|r\nBuff icons and names are still shown, but timer bars display as |cFFFFFFFF\226\136\158|r (infinity) because Blizzard restricts access to timing data in these contexts. Spells on Blizzard's internal whitelist will show full timers even in instances — this list is gradually expanding.\n\n|cFFFF2020This is a Blizzard restriction (\"secret values\"), not a bug.|r\n\nThe addon will never crash from this restriction — it degrades gracefully to icon-only display when timing data is unavailable.\n\nThis addon remains fully functional on all Classic clients (Era, SoD, Cata, Wrath) where these restrictions do not apply."
