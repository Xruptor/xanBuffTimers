...
L.RetailWarningBody = "xanBuffTimers는 이제 리테일 지원이 향상되었지만, 동작은 위치에 따라 달라집니다:\n\n|cFF00FF00오픈 월드 / 전장:|r\n완전히 작동합니다. 버프 아이콘, 타이머, 바가 정상적으로 표시됩니다.\n\n|cFFFFFF00인스턴스 / 레이드 / 투기장:|r\n버프 아이콘과 이름은 계속 표시되지만, Blizzard가 이런 환경에서 타이밍 데이터 접근을 제한하기 때문에 타이머 바는 |cFFFFFFFF\226\136\158|r (무한대)로 표시됩니다. Blizzard 내부 허용 목록에 있는 주문은 인스턴스에서도 전체 타이머를 표시합니다 — 이 목록은 점점 늘어나고 있습니다.\n\n|cFFFF2020이것은 Blizzard의 제한 사항 (\"비밀 값\")이며, 버그가 아닙니다.|r\n\n이 제한으로 인해 애드온이 충돌하지 않습니다 — 타이밍 데이터를 사용할 수 없을 때 아이콘만 표시되는 방식으로 자동 전환됩니다.\n\n이 애드온은 이러한 제한이 적용되지 않는 모든 클래식 클라이언트 (에라, SoD, 카타, 격분)에서 완전히 작동합니다."
